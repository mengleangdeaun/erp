...
import noFolderSvg from '@/assets/illustrations/NoFolder.svg';
...
export const NoFolderIllustration = () => (
    <div className="flex flex-col items-center justify-center py-2">
        <img src={noFolderSvg} alt="No Folder" className="w-[120px] h-[120px] object-contain" />
    </div>
);
